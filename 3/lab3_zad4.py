...
class neuralNetwork:
    ...
    def predict(self, input_vector, layer_number):
        ...
        debug1_shape = debug1.shape
        debug2_shape = debug2.shape
        # if layer_number==0:
    ...
    def update_weights(self, expected, alpha, cycles):
        ...
        for b in range(cycles):
            ...
            for a in range(self.input_data[0].shape[0]):
                ...
                for i in range(len(self.data)):
                    if i == 0:
                        ...
                        # layer_hidden_1_delta = np.multiply(layer_hidden_1_delta, (out[-2]))
                        # layer_hidden_1_delta = np.multiply(layer_hidden_1_delta, temp_vec_function(layer_output_delta))
            ...
            print(correct_counter/60000*100)
            # if int(correct_counter/109)==1:
            #     return correct_counter,b
...
# matrix_size = [3, 4]
input_size = [784,1]
hidden_weights_size = [40, 784]
output_weights_size = [10, 40]
...
correct, res=myNetwork2.update_weights(expected,alpha,5)
